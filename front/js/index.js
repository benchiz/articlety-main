...
// const regBtn = document.querySelector('.registration__submit');
// const regBlock = document.querySelector('.registration__blocks');

// regBtn.addEventListener('click', function (e) {
//     e.preventDefault()
//     regBlock.textContent = 'Вы зареганы!'
//     regBtn.textContent = 'OK!';
// })
